...
pygame.display.set_caption("Spaceship Combat")
...
def main():
    ...
    level = 0
    lives = 5
    main_font = pygame.font.SysFont("timesroman", 30)
    lost_font = pygame.font.SysFont("timesroman", 30)
...
def main_menu():
    title_font = pygame.font.SysFont("timesroman", 40)
    run = True
    while run:
        WIN.blit(BG, (0,0))
        title_label = title_font.render("Space War Begins, Play Now!", 1, (255,255,255))
